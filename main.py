...
if args.input is None:
    ...
    input_file = r"C:\Users\noname\Desktop\Project\UHBM\lab\senha.exe"
    #input_file = r"D:\catnap2\libil2cpp.so1"
else:
    input_file = args.input
if args.output is None:
    #output_file = input("모드 적용이 된 파일이 생성될 경로: ")
    output_file = r"C:\Users\noname\Desktop\Project\UHBM\lab\senha_modded2.exe"
else:
...
if args.mods is None:
    ...
    while True:
        ...
        if mod == "":
            break
        mods.append(mod)"""
    mods = [r"C:\Users\noname\Desktop\Project\UHBM\lab\senha_cheongsonyeongdang"]
    #mods = [r"C:\Users\noname\Desktop\Project\UHBM\lab\teacher"]
else:
